...
SELECT * FROM apt_trade_dongdaemun WHERE DEALYEAR=2024 AND DEALMONTH=12;
TRUNCATE TABLE apt_trade_seongdong;
SELECT COUNT(*) FROM apt_rent_jongro WHERE DEALYEAR=2024 AND DEALMONTH=12;
...
SELECT APTNM FROM apt_trade GROUP BY APTNM;
 ...
 SELECT t1.id, t2.id AS id2,t1.APTNM, t1.EXCLUUSEAR, t2.EXCLUUSEAR, t1.DEALAMOUNT, t2.DEPOSIT, t2.MONTHLYRENT, t1.FLOOR,
...
SELECT * FROM apt_trade_yongsan WHERE DEALYEAR=2024 AND DEALMONTH=12;
