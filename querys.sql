...
SELECT COUNT(*) FROM apt_trade_junggu;
...
SELECT * FROM apt_trade_seongdong WHERE DEALYEAR=2024 AND DEALMONTH=11;
SELECT * FROM apt_rent_seongdong WHERE DEALYEAR=2024 AND DEALMONTH=11;
...
FROM apt_trade_seongdong t1, apt_rent_seongdong t2
...
AND ABS(CAST(REPLACE(t1.DEALAMOUNT,',','') AS SIGNED) - CAST(REPLACE(t2.DEPOSIT,',','') AS SIGNED)) <= 20000
